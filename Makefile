...
HEADERS=rtv1.h
INCLUDE=. src/brackets/ src/maths/ src/maths/vec3f src/objects/ libft libft/string libft/mem libft/array libft/printf/includes ./ $(MOUS) SDL2_ttf-2.0.14/ SDL2_image-2.0.3/
