...
/*   Updated: 2018/04/10 17:16:09 by scornaz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
   return (t_vec3f){
       matrix.right.x * vector.x + matrix.up.x * vector.y + matrix.forward.x * vector.z,
           matrix.right.y * vector.x + matrix.up.y * vector.y + matrix.forward.y * vector.z,
           matrix.right.z * vector.x + matrix.up.z * vector.y + matrix.forward.z * vector.z,
           };
}
